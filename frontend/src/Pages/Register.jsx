...
function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-black to-gray-800 px-4">
      <form onSubmit={handleSubmit} className="w-full max-w-2xl bg-gray-900 rounded-2xl shadow-2xl p-10 space-y-6 border border-gray-700">
        ...
        <button type="submit" className="w-full py-3 text-lg font-semibold bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg hover:from-orange-500 hover:to-yellow-500 transition duration-300">
          Register
        </button>
      </form>
    </div>
